  ...
  return (
    <Listbox value={formik.values.business_location}
      ...
      <div className="relative">
        <ListboxButton className="flex items-center w-[100%]   h-[44px] p-[16px] gap-[8px] rounded-[12px] border border-gray-300 text-left text-gray-900 bg-white">
          <img
            alt=""
            src={formik.values.business_location?.flag}
            className="w-5 h-5 rounded-full"
          />
          <span className="truncate text-sm font-normal text-[#66708510">
            {formik.values.business_location?.name}
          </span>
