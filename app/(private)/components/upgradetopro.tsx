                ...
                <div className='w-[400px] h-auto rounded-[16px] bg-[#FFFFFF]'>
                    ...
                    <div className='flex flex-col items-center w-[400px] h-auto p-[40px] gap-[16px]'>
                        <div className='w-[320px]'>
                            <ul className='flex flex-col gap-[16px]'>
                                <li className='text-[#101828] font-semibold text-[18px] font-sans'>
                                    Upgrade to Pro to Run your space
                                </li>
                                <li className='w-[320px] rounded-[8px] p-[12px] bg-[#685BC71F] text-[#685BC7] font-sans font-400 text-[14px]'>
                                ...
                                <li className='w-[320px] h-[40px] text-[#475467] font-400 text-[14px] font-sans'>
                                    This is a premium feature available exclusively on our Pro plan. Upgrade to Pro to unlock it.
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className='flex justify-center flex-col w-[400px] p-[20px] h-auto border-t-[1px] border-t-[#EAECF0] gap-[12px]'>
                        <button
                            ...
                            className='flex justify-center font-sans w-[360px] rounded-[8px] text-white bg-[#685BC7] pt-[8px] pr-[16px] pb-[8px] pl-[16px]'
                        >
                            Pay $499
                        </button>
                    </div>
