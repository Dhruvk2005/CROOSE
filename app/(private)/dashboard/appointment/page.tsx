      ...
      const updatedAppointments: any = appointments.map((appt: any) =>
        appt.id === id
          ? {
              ...
              status: newStatus,
              statusColor:
                statusColorMap[newStatus.toLowerCase()] || "bg-gray-300",
            }
          : appt
      );
          ...
          <div className="w-full h-auto p-[32px] flex flex-col gap-[24px] ">
            <ul className=" w-[full] flex flex-wrap gap-[16px] ">
              <li className="w-full  lg:w-[32.2%] border-[2px] rounded-[12px] border-[#EAECF0] p-[24px] ">
                <p className="text-[#475467] text-[14px] font-medium font-Inter">
                  New Appointments
                </p>
            ...
            <li className=" w-full gap-[12px] flex items-center ">
              <button   className="px-[14px] py-[10px] flex gap-[4px] border-[2px] rounded-[8px] border-[#EAECF0]  ">
                <Icon
                  ...
                  style={{ color: "#667085" }}
                />
                <p className="text-[#344054] font-Inter font-semibold text-[14px] ">
                  Filters
                </p>
              </button>
              <select
                ...
                className="text-[#344054] font-Inter font-semibold text-[14px]  px-[14px] py-[10px] flex gap-[4px] border-[2px] rounded-[8px] border-[#EAECF0]"
              >
            ...
            <tbody>
              {filteredAppointments.map((appt: any) => (
                ...
                >
                  ...
                  <td
                    className="px-4 py-3 text-[#101828] "
                    style={{
                      font: "Inter",
                      fontWeight: "500",
                      fontSize: "14px",
