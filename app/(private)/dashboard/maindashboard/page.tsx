...
const slideData = [
  ...
  //  {   //   image: "/bank.png",   //   name: "Add bank details",   //   description: "Add your company bank details to the platform. This way your business can get paid refunds or other payments due to you by the platform or your customers.",   //   bg: "#F0EBE5",   //   link:""   // },
];
      ...
      <div className='w-full h-auto px-[24px] py-[40px] gap-[20px] flex flex-col'>
        ...
        <div className='w-full h-auto'>
          <ul className='w-full h-auto flex flex-wrap gap-[16px]'>
            {[1, 2, 3, 4].map((item, idx) => (<li key={idx} className='w-full sm:w-[48%] lg:w-[24%] h-[160px] border-2 border-[#EAECF0] rounded-[16px]'>
              <div className='w-full font-sans flex gap-[8px] p-[12px] items-center h-[44px] border-b-2 border-[#EAECF0] text-[12px] font-semibold text-[#475467]'>
                <Icon icon="humbleicons:chat" width="24" height="24" style={{ color: "#475467" }} />Total Chats                 </div>
              <div className='flex h-[116px] text-[36px] justify-center items-center text-black font-bold'>0</div>               </li>))}
          </ul>
        </div>
