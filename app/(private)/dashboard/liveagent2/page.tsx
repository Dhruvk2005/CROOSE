import React from 'react'
 ...
 const users=[
    ...
    {number:"+233456789012", sms:"What are the available payment..." ,time:"10:15" , batton:'Complete Sale',img: "/Profiledummy.png"},
    {number:"+233456789012",img: "/Profiledummy.png" , sms:"How much exactly does all your " }
 ]
...
<div className="h-[378px] overflow-y-hidden overflow-x-hidden scrollbar-hide">
  {users.map((user, index) => (
    <div key={index} className={`w-full sm:w-[320px] h-[87px] flex gap-2 pt-[15px] pl-[15px] pr-[10px] opacity-100 rotate-0  ${index > 1 ? ' opacity-10' : ''}  `}>
      
      {/* Fixed-size image container */}
      <div className={`w-[32px] h-[32px] rounded-full overflow-hidden flex-shrink-0 bg-[#E4E4E7] ${index > 1 ? ' opacity-50' : ''} `}>
        {user.img && (
          <img
            src={user.img}
            alt="user"
      ...
      <div className={`flex-1 flex flex-col  border-b border-zinc-200 ${index > 1 ? ' opacity-50' : ''} `}>
