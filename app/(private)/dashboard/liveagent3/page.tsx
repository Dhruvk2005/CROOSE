import React from 'react'
 ...
 const users=[
    {number:"Mom 💕", sms:"Mom is typing..." , batton:'General' ,time:"19:45" ,count:'5',img: "/Profile.png"},
    {number:"+233847048730", sms:"How much exactly does all your " ,time:"19:45" ,count:'5', batton:'Enquiry',img: "/Profiledummy.png"},
    {number:"+234567890123", sms:"Can you send me the detailed report?" ,time:"14:15" , batton:'Broken',img: "/Profiledummy.png"},
    {number:"+233456789012", sms:"What are the available payment..." ,time:"10:30" , batton:'Complete Sale',img: "/Profiledummy.png"},
    ...
    <section className='w-full sm:w-[320px] h-auto sm:h-[603px] opacity-100 rounded-[16px] border border-[#E4E4E7]'>
      <div className='w-full sm:w-[320px] h-[56px] rotate-0 opacity-100 gap-2 border-b pb-[12px] pt-[12px] pl-[12px] pr-[12px] border-[#E4E4E7]'>
        <div className='w-full sm:w-[296px] h-[20px] flex items-center rotate-0 opacity-100 gap-3'>
          ...
          <span className='w-auto h-[20px] mt-3 font-semibold text-sm leading-5 align-bottom text-[#18181B]'>Live Chats </span>
        </div>
      </div>
...
<div className="h-[547px]  overflow-y-hidden  overflow-x-hidden scrollbar-hide">
  {users.map((user, index) => (
    <div key={index} className='w-full sm:w-[320px] h-[84px] flex gap-2 pt-[15px] pl-[15px] pr-[10px] opacity-100 rotate-0'>
      ...
      <div className="flex-1 flex flex-col  border-b border-zinc-200">
        <div className="font-sans font-semibold text-sm leading-[100%] text-[#0A0A0A] truncate">{user.number}</div>
        <div className="font-sans font-normal text-xs leading-5 truncate">{user.sms}</div>
        <div className="font-sans font-normal text-xs leading-4 text-[#71717A]">
          <span
            className={`w-[54px] h-[20px] opacity-100 gap-[10px] pt-[2px] pr-[5px] pb-[2px] pl-[5px] rounded-[4px] font-sans font-normal text-xs leading-4 
              ${user.batton === 'General' ? 'bg-[#F4F4F5] text-black' : ''}
              ${user.batton === 'Enquiry' ? 'bg-[#FEF3C7] text-[#78350F]' : ''}
              ${user.batton === 'Broken' ? 'bg-[#FEE2E2] text-[#7F1D1D]' : ''}
              ${user.batton === ' Enquiry' ? 'bg-[#DCFCE7] text-[#14532D]' : ''}   
      ...
      {/* ✅ Fixed Time Column (stacked properly) */}
      <div className='w-[50px] h-[36px] flex flex-col items-end    border-zinc-200'>
        <span
          className={`font-sans font-normal text-xs leading-4 
            ...
            ${user.batton === 'Complete Sale' ? 'text-[#71717A]' : ''}
    ...
    <section className='w-full sm:w-[752px] h-auto sm:h-[603px] flex justify-center  flex-col opacity-100 rounded-[16px] rotate-0 border border-[#E4E4E7]'>
     ...
     <div className="w-[628px] h-[14px] flex items-center opacity-100">
        <span className="font-sans font-semibold text-sm leading-[100%] text-[#0A0A0A] tracking-normal">+233847048730</span>
     </div>
     <div className="w-[52px] h-[20px] opacity-100 gap-[2px]">
        <div className="w-[52px] h-[20px] opacity-100 gap-[10px]   bg-[#FEF3C7] rounded-[4px]">
            <span className='w-[46px] h-[16px] font-sans font-normal text-[#78350F] text-center flex items-center justify-center not-italic text-xs leading-4 tracking-normal'>Enquiry</span>
