...
const Page = () => {
    ...
    <>
      <div className="h-[900px] w-full bg-[#FFFFFF] relative flex flex-col gap-5  ">
        <div className='w-[100%] border border-b-1px items-center mt-[-17px]   flex flex-row h-[64px] '>
          ...
          <div className='w-[70%] text-[#101828] ml-[18px] font-sans font-semibold text-lg leading-7 tracking-normal align-middle h-[28px]'>Space Name</div>
          <div className='w-[211px] right-[0px] flex flex-row  gap-[8px] h-[36px]'>
            <div className='w-[103px] h-[36px] flex flex-row border pt-2 pr-4 pb-2 bg-[#EAECF0] pl-4 gap-[10px] rounded-[8px]'>
              <div className='font-sans font-semibold text-sm w-[71px] leading-5 tracking-normal text-center  text-[#685BC7] h-[20px]'>Spaces IQ</div>
            </div>
            <div className='w-[103px] h-[36px] flex flex-row pt-2 pr-4 pb-2 pl-4 gap-[10px] bg-[#685BC7] rounded-[8px]'>
              <div className='w-[71px] font-sans font-semibold text-sm leading-5 tracking-normal text-center text-[#FFFFFF] h-[20px]'>Run Agent</div>
            </div>
          </div>
        </div>
        {/* <Navbar /> */}
      ...
      <div className='w-[260p] rounded-[16px] border border-gray-300 h-[160px]'>
        ...
        <div className='w-[100%] flex flex-row items-center justify-center  border border-b-[#EAECF0] gap-[10px]  rounded-t-[10px] h-[60px]'>
          <div className='h-[32px] bg-[#F2F4F7] border border-[#F2F4F7] p-[8px] flex  gap-[10px]  rounded-[8px] w-[32px]'>
            <img src="/message-circle.png" alt='circle-sms' className='bg-[#EAECF0] height-[16px] w-[16px]  flex rounded-lg '/></div>
            <p className='font-sans w-[937px] h-[24px] text-[#101828]  font-semibold text-base leading-6 tracking-normal align-middle'>Live Chats</p>
        ...
        <div className='h-[307px]  p-[24px] flex justify-center items-center gap-[24px] [1088px]'>
          <div className='w-[256px] h-[208px] flex items-center justify-center flex-wrap  rounded-[8px] gap-[20px]'>
            ...
            <img src="/adda.png" alt='circle-sms'  className=' h-[24px] w-[24px]' /></div>
            
            <div className='h-[84px] gap-[4px] flex flex-col w-[256px]'>
            <div className='w-[256px] h-[20px] text-[#101828] font-sans    font-semibold text-sm leading-5 tracking-normal text-center'>No live chats yet</div>
            <div className='w-[256px] text-[#475467] font-sans font-normal text-sm leading-5 tracking-normal text-center align-bottom h-[60px]'>Connect your chat accounts, and customize them, to see live chats and conversations</div>
  ...
  <div className='w-[148px] flex flex-row rounded-[8px] pt-[8px] pr-[16px] border border-gray-200 pl-[16px] pb-[8px] gap-[10px] bg-[#F2F4F7] h-[36px]'>
    <div className='w-[116px] h-[20px] font-sans font-semibold text-sm leading-5 tracking-normal text-center text-[#101828]'>Connect account</div>
  </div>
          </div>
        </div>
